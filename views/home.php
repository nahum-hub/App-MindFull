...
<body class="bg-gray-50 flex flex-col min-h-screen font-sans text-gray-900">
    ...
    <main class="flex-grow flex items-center justify-center py-20 px-4">
        <div class="max-w-3xl w-full text-center space-y-8">
            ...
            <div class="pt-6">
                <?php if ($isLoggedIn): ?>
                    <a href="/module/dashboard" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg py-4 px-10 rounded-full shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
